 ...
 * provided. `--host 0.0.0.0` binds all interfaces; the browser-session
 * authentication owned by the Connection plugin protects every Host API route
 * and stream, and the LAN URL printed at startup carries the process token.
