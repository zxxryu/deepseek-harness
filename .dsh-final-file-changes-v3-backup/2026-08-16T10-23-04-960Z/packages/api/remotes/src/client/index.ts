...
import fileChangesRemote from '@deepseek-ai/dsh-file-changes/remote'
...
export type {} from '@deepseek-ai/dsh-file-changes/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, fileChangesRemote, dynamicRemote, pluginInventoryRemote, messageFeedbackRemote,
    ]) {
